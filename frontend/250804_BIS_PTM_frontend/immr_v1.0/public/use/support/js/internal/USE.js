 ...
 */
angular
  .module("IPSA.directive", [])
  .directive("annotatedSpectrum", function ($log) {
    /**
    ...
    directive.link = function (scope, elements, attr) {
      ...
      scope.getTickData = function (topSpectrum = true) {
        ...
        var length = topSpectrum
          ? scope.getSequence().length
          : scope.getSequenceBottom();
        var labelObj;
        var i;
        var tempLabel;
      ...
      scope.initialize = function () {
        ...
        scope.plotContainer = scope.container
          .append("g")
          .attr("id", "annotationContainer");
        // container to hold annotated spectrum
        scope.plotContainer2 = scope.container2
          .append("g")
          .attr("id", "annotationContainer2")
          .attr("display", "none");

        // container to hold mass error dot plot
        scope.massErrorContainer = scope.fragmentContainer
          .append("g")
        ...
        scope.container.attr(
          "transform",
          "translate(" +
            options.annotation.margin.left +
            ", " +
            (options.annotation.margin.top - 40) +
            ")"
        );
      ...
      scope.drawInteractiveTitleBottom = function () {
        ...
        dataset = scope.titleContainerBottom
          .selectAll(".aminoacid")
          .data(sequence);
        ...
        if (sequence.length < 22) {
          ...
          dataset
            .attr("x", function (d, i) {
              ...
              return x(
                interactiveChartWidth / 2 + indexDistance * spacingFactor
              );
            })
            .attr("opacity", 0)
      ...
      scope.drawCorrelationSummary = function (topSpectrum = true) {
        var options = scope.getOptions(),
          ...
          correlation = topSpectrum
            ? scope.scoretop.corr
            : scope.scorebottom.corr,
          stat_width = topSpectrum
            ? options.statistics.width
            : options.statisticsBottom.width,
          stat_mar_catpad1 = topSpectrum
            ? options.statistics.margin.categoryPadding_1
            : options.statisticsBottom.margin.categoryPadding_1,
        ...
        if (topSpectrum) {
          dataset = scope.statisticsContainer
            .selectAll(".precursorstatscategory")
            .data(statisticsData);
          dataset
            .enter()
            .append("text")
            .attr("class", "precursorstatscategory");
        } else {
          dataset = scope.statisticsContainerBottom
        ...
        dataset
          ...
          .attr("transform", function (d, i) {
            if (i == 0) {
              ...
              return (
                "translate(" + (stat_width / 2 - stat_mar_catpad3) + ",25)"
              );
            }
          })
        ...
        dataset
          ...
          .attr("transform", function (d, i) {
            if (i == 0) {
              return (
                "translate(-" +
                (stat_width / 2 + stat_mar_datpad1 - 100) +
                ",25)"
              );
            } else if (i == 1) {
      ...
      scope.drawOriginSummary = function (topSpectrum = true) {
        ...
        statisticsData.push({
          title: "Origin: ",
          data: scope.getModifications2(topSpectrum),
        });

        if (topSpectrum) {
          dataset = scope.originContainer
            .selectAll(".origincategory")
            .data(statisticsData);
          dataset.enter().append("text").attr("class", "origincategory");
        } else {
          dataset = scope.originContainerBottom
...
*/
        ...
        if (topSpectrum) {
          ...
          dataset
            .enter()
            .append("text")
            .attr("class", "origindataBottom origin");
        }
...
*/
      ...
      scope.drawPrecursorSummary = function () {
        ...
        summaryData.push({
          title: "Charge: ",
          data: ionizationMode + Math.abs(charge),
        });
        summaryData.push({
          title: "Fragmented Bonds: ",
          data: scope.getFragmentedBonds(fragments, sequence.length),
        });
        ...
        summaryDataBottom.push({
          title: "Charge: ",
          data: ionizationMode + Math.abs(chargeBottom),
        });
        summaryDataBottom.push({
          title: "Fragmented Bonds: ",
          data: scope.getFragmentedBonds(
            fragmentsBottom,
            sequenceBottom.length
          ),
        });

        // From line 1047 to 1065 we write the Title text from the summary data objects e.g. "Precursor m/z"
        dataset = scope.peptideContainer
          .selectAll(".precursorstatscategory")
          .data(summaryData);
        datasetBottom = scope.peptideContainerBottom
          .selectAll(".precursorstatscategoryBottom")
      ...
      scope.drawAnnotation = function () {
        ...
        if (xValues && yValues) {
          ...
          scope.container
            ...
            .attr(
              "transform",
              "translate(0, " + options.annotation.height + ")"
            )
            .call(xAxis);
          ...
          labelDataset = scope.plotContainer
            .selectAll(".barlabel")
            .data(plotData);
          ...
          // bind the plotData variable to potential svg rectangle elements.
          barDataset2 = scope.plotContainer2
            .selectAll(".bar")
            .data(mirrorPlotData);
          // bind the plotData variable to potential svg text elements.
          labelDataset2 = scope.plotContainer2
            .selectAll(".barlabel")
            .data(mirrorPlotData);
          // bind the plotData variable to potential svg path elements.
          lineDataset2 = scope.plotContainer2
            .selectAll(".line")
            .data(mirrorPlotData);
          ...
          labelDataset
            .on("mouseenter", function (d, i) {
              ...
              var interactiveTitleObjects = scope.titleContainer
                .selectAll("text")
                .data(sequence);
              ...
              var massErrorCircles =
                scope.massErrorContainer.selectAll(".masserror");
      ...
      scope.drawMassError = function () {
        ...
        if (xValues && yValues) {
          ...
          */
          ...
          var massErrorLabel = scope.fragmentContainer
          ...
          circleDataset = scope.massErrorContainer
            .selectAll(".masserror")
            .data(plotData);
          ...
          // draw the zero line
          var dataset = scope.massErrorContainer
            .selectAll(".zeroline")
            .data(baseLine);
          ...
          circleDataset.on("mouseenter", function (d, i) {
            ...
            var formattedLabel = formatLabel(
              label,
              neutralLoss,
              charge,
              ionizationMode
            ...
            let fitting_top_peak = scope.plotContainer
              .selectAll(".bar")
              .filter(function (e, j) {
                // return e.id == d.bottom_id;
                return e.id == d.top_id;
              });
            let fitting_bottom_peak = scope.plotContainer2
              .selectAll(".bar")
              .filter(function (e, j) {
                return e.id == d.bottom_id;
              });
            ...
            var labelObj = scope.plotContainer
              .selectAll(".barlabel")
              .filter(function (e, j) {
                return e.id == d.top_id;
              });
            ...
            var labelObj = scope.plotContainer2
              .selectAll(".barlabel")
              .filter(function (e, j) {
                return e.id == d.bottom_id;
              });
